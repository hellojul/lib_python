...
def create_nested_directories(path: str) -> None:
    """
    Crée un ensemble de répertoires imbriqués (ex: 'parent/enfant').
    """
    os.makedirs(path)

def remove_nested_directories(path: str) -> None:
    """
...
def rename_file_or_directory(old_path: str, new_path: str) -> None:
    """
...
def get_last_modified_time(path: str) -> datetime:
    """
...
def archive_directory(source: str, archive_name: str) -> str:
    """
...
def search_files_by_extension(directory: str, extension: str) -> list:
    """
